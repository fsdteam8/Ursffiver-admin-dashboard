      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            View and manage all registered users, their status, and account details in one place.
          </p>
        </div>
        <Button className="bg-blue-600 hover:bg-blue-700">Pending verify (123)</Button>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-700">User Location</th>
              ...
              {isLoading
                ...
                : filteredUsers.map((user: User) => (
                    <tr key={user._id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4 text-sm text-gray-600">{getLocation(user)}</td>
                      <td className="py-4 px-4 text-sm text-gray-600 capitalize">{user.gender}</td>
                      <td className="py-4 px-4 text-sm text-gray-600">{getAgeRange()}</td>
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-1">
                          <div className="w-4 h-4 bg-blue-600 rounded flex items-center justify-center">
                            <span className="text-xs text-white font-medium">🏆</span>
                          </div>
                          <span className="text-sm text-gray-600">{user.interest?.length || 0}</span>
                        </div>
                      </td>
